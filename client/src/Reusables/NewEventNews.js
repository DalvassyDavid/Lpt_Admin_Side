...
function NewEventNews() {
  ...
  const handleCreateNewMember = () => {
    ...
    formData.append("description", description);
      ...
      axios.post(`http://localhost:8000/createvent`, formData).then((res) => {
        if (res.data === "fail") {
    ...
    <div>
      ...
      <div>
        <div className="form-style-7">
          <ul>
            <li>
              <label htmlFor="name">Occassion/Event</label>
              <input
                type="text"
                name="occassion"
                maxLength="100"
